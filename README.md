[![Build and deploy](https://github.com/yonadev/yona-server/actions/workflows/build-deploy.yml/badge.svg)](https://github.com/yonadev/yona-server/actions/workflows/build-deploy.yml)
