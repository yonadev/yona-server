...
public interface SmsService
{
	...
	public static final String TemplateName_OverwriteUserConfirmation = "overwrite-user-confirmation";
	public static final String TemplateName_PinResetRequestConfirmation = "pin-reset-request-confirmation";
