...
public interface MessageRepository extends CrudRepository<Message, UUID>
{
	...
	@Query("select m from Message m, MessageDestination d where d.id = :destinationID and m member of d.messages and m.activityID = :activityID order by m.creationTime desc")
