...
set ADD_OPEN_ARGS=--add-modules java.se --add-exports java.base/jdk.internal.ref=ALL-UNNAMED --add-opens java.base/java.lang=ALL-UNNAMED --add-opens java.base/sun.nio.ch=ALL-UNNAMED --add-opens java.management/sun.management=ALL-UNNAMED --add-opens jdk.management/com.sun.management.internal=ALL-UNNAMED
call gradlew adminservice:build && start "Admin service" java -ea -Xdebug -Xrunjdwp:transport=dt_socket,address=8840,server=y,suspend=n -Dyona.testServer=true -Dyona.enableHibernateStatsAllowed=true %ADD_OPEN_ARGS% -jar adminservice\build\libs\adminservice-0.0.8-SNAPSHOT-full.jar --server.port=8180 --management.server.port=9080 --spring.jpa.hibernate.ddl-auto=none
